...
<style>
    ...
    * {
    ...
    [data-theme="light"] .stAlert.error {
        border-left-color: #dc2626 !important;
    }
    [data-theme="light"] .stAlert.warning {
        border-left-color: #facc15 !important;
    }
    [data-theme="light"] .stAlert.success {
        border-left-color: #22c55e !important;
    }
    [data-theme="light"] .stAlert.info {
    ...
    [data-theme="dark"] .stAlert.error {
        border-left-color: #dc2626 !important;
    }
    [data-theme="dark"] .stAlert.warning {
        border-left-color: #facc15 !important;
    }
    ...
    /* Override Streamlit's default metric styles to match our theme */
    ...
    [data-theme="dark"] [data-testid="metric-container"] .stMetric > div:first-child {
    ...
    [data-theme="dark"] [data-testid="metric-container"] .stMetric > div:last-child {
        color: #facc15 !important;
    }
</style>
