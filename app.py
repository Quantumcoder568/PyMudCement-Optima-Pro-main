...
# ============================
st.markdown(
    f'<div class="main-header"><img src="data:image/png;base64,{logo_base64}" style="height: 4.4rem; margin-right: 0.5rem; vertical-align: middle; border-radius: 20px;"> PyMudCement Optima Pro</div>',
...
with col2:
    st.markdown('<div class="main-header" style="margin-top: 0;">PyMudCement Optima Pro</div>', unsafe_allow_html=True)
...
# Footer
st.markdown('<div class="footer">© 2026 PyMudCement Optima Pro</div>', unsafe_allow_html=True)
